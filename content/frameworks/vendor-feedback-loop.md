+++
title = "The Vendor Feedback Loop"
summary = "Organisational fragmentation shapes the vendor market, which packages that fragmentation and sells it back to each function at full price."
description = "How an organisation's internal fragmentation gets reinforced by the market it buys from."
date = 2026-06-14
featured = false
...
[[relatedEssays]]
title = "Locally Rational, Globally Expensive"
href = "/essays/locally-rational-globally-expensive/"
+++
...
Breaking the loop is not a centralisation exercise. It is governing the common mechanism while leaving local execution local. The structural reason organisations fall into this is set out in [The Kinetic Enterprise](https://kineticorganization.com). CEZ Consulting works with executives to see the loop they are inside and to buy against the mechanism rather than the org chart.
